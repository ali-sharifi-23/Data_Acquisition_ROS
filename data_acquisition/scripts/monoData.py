...
# Threaded subscriber wrapper
def threaded_subscriber(subscriber, callback, topic, queue_size=10):
    def run():
        rospy.Subscriber(topic, subscriber, callback, queue_size=queue_size)
        rospy.spin()
...
if __name__ == "__main__":
    try:
        ...
        # Create threads for pose and image subscribers
        threaded_subscriber(PoseStamped, pose_callback, pose_topic)
        threaded_subscriber(Image, image_callback, image_topic)
